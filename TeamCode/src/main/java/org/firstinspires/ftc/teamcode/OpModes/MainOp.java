...
public class MainOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()){
            Controls.Update();
            if(Controls.gamepad2.gamepad.right_trigger>0.1){IntakeFSM.startIntake();} else if(Controls.gamepad2.gamepad.left_trigger>0.1){Sweeper.outtake();} else {if(IntakeFSM.currentState!= IntakeFSM.State.FULL)IntakeFSM.stopIntake();}
            ...
            if(Controls.gamepad1.wasPressedRB) Claw.open();
            ...
            if(Controls.gamepad1.wasPressedLB)ClimbFSM.startClimb();
            IntakeFSM.update();
            OuttakeFSM.update();
            ClimbFSM.update();
